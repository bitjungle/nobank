...
# lemma_paradigme.txt inneholder LEMMA_ID som ikke finnes i lemma.txt.

lemma_paradigme = pd.read_csv("ordbank/lemma_paradigme.txt", sep="\t", dtype=str, index_col='LOEPENR')

# Finn hvilke ID-er som er problemet
invalid_lemmas = lemma_paradigme[~lemma_paradigme["LEMMA_ID"].isin(lemma["LEMMA_ID"])]

print("❌ Rader i lemma_paradigme med manglende LEMMA_ID:")
print(invalid_lemmas)
